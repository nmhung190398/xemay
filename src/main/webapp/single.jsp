<%-- 
    Document   : detail
    Created on : Mar 31, 2017, 7:36:03 AM
                ...
                <div class="single">
                    ...
                    <div class="col-md-7 single-top-in">
                        <div class="single-para">
                            ...
                            <div class="para-grid">
                                <span class="add-to"><%=String.format("%,.0f", product.getProductPrice())%> VNĐ</span><br />
                                 <a style="margin-left: 72px;margin-top: 7px; background-color: #0076F9" href="CartServlet?command=plus&productID=<%=product.getProductID()%>" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">MUA NGAY</a>					
